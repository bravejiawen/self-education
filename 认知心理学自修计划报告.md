...
| 学习与记忆          | 在认知心理学导论和认知神经科学中会有介绍，这里主要作为重点学习的方向，旨在以实践为导向对知识点进行深入和系统的梳理。寻找更高效获得知识、内隐知识的方法，一般应用于教育。 | Richard M Ryan   Howard Gardner   Ahmad Alaeraini   Allan Collins   James S. Coleman   Daniel Willingham | Journal of Applied Research in Memory and Cognition   (JARMAC)   Society for Applied Research in Memory and  Cognition(SARMAC) |
...
- 从爱好出发（看书籍对某个领域产生兴趣，想深入了解）
  ...
  - 科普作品的选择。认知科学经阳老师推广，我们基本上能知道哪些是比较好的作品。那其他的学科呢。我的做法是找出维基百科该类目下涉及的学者、该关键字在谷歌学术上引用量前50或前20的学者、他人整理好的大牛排名，Acemap等综合，制好表格理出h值，取h值靠前的学者，找出他们的作品。
